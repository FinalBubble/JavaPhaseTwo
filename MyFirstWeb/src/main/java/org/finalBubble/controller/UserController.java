package org.finalBubble.controller;

import org.finalBubble.entity.User;
...
public class UserController {
    ...
    public void showAllUser(HttpServletRequest request, HttpServletResponse response) {
        ...
        //PrintWriter可以按行写出字符串,自动链接了response中声明的byteArrayOutputStream流
